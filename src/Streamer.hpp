#ifndef REAL_TIME_OBJECT_DETECTION_STREAMER_H
#define REAL_TIME_OBJECT_DETECTION_STREAMER_H
...
namespace streamer {
    ...
    struct StreamerConfig {
        ...
        StreamerConfig(int source_width, int source_height, int stream_width, int stream_height, int stream_fps,
                       int stream_bitrate,
...
#endif //REAL_TIME_OBJECT_DETECTION_STREAMER_H
