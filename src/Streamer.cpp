...
#define STREAM_PIX_FMT    AV_PIX_FMT_YUV420P
    ...
    static int
    set_options_and_open_encoder(AVFormatContext *fctx, AVStream *stream, AVCodecContext *codec_ctx, AVCodec *codec,
    ...
    int Streamer::init(const StreamerConfig &streamer_config) {
        ...
        scaler.init(out_codec_ctx, config.src_width, config.src_height, config.dst_width, config.dst_height,
                    SWS_BILINEAR);
